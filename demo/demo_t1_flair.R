...
flair_model <- config %>% create_model_from_config()
...
flair_model %>% save_model(path = saving_path, prefix = saving_prefix, comment = "After training")
